# n8n Installation Guide - KeyBuzz

Guide complet d'installation de n8n sur Hetzner Cloud pour KeyBuzz.

## 📋 Prérequis

- Serveur Hetzner CPX21 (4GB RAM, 2 vCPU)
- Ubuntu 24.04 LTS
- Domaine : n8n.keybuzz.io
- IP publique : 195.201.98.217
- IP privée : 10.0.0.2
...
wget https://raw.githubusercontent.com/KeyBuzz/n8n/main/n8n-install.sh

# Ou avec curl
curl -o n8n-install.sh https://raw.githubusercontent.com/KeyBuzz/n8n/main/n8n-install.sh
...
Si vous préférez une installation pas à pas :

```bash
# Cloner le repository
git clone https://github.com/KeyBuzz/n8n.git
cd n8n
...
Créez le fichier `n8n-install.sh` sur https://github.com/KeyBuzz/n8n/ :
...
1. **OpenAI**
   - Dans n8n : Credentials → New → OpenAI
   - Ajoutez votre clé API

2. **Groq (recommandé - ultra rapide)**
...
- **Logs** : Dans `/var/log/n8n/`
- **Updates** : `npm update -g n8n`
...
- Repository : https://github.com/KeyBuzz/n8n
- Issues : https://github.com/KeyBuzz/n8n/issues
- Email : ludovic@keybuzz.pro

## 📄 License

MIT License - KeyBuzz 2025
